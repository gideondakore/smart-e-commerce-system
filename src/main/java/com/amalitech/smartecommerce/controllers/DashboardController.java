...
public class DashboardController {
    ...
    @FXML
    private TableColumn<CartEntry, String> colCartName;
    @FXML
    private TableColumn<CartEntry, Integer> colCartQty;
    @FXML
    private TableColumn<CartEntry, Double> colCartPrice;
    @FXML
    ...
    private void handleEdit() {
        ...
        Spinner<Double> priceSpinner = new Spinner<>(0.01, 100000.0, selected.getPrice(), 1.0);
        priceSpinner.setEditable(true);

        Spinner<Integer> stockSpinner = new Spinner<>(0, 10000, selected.getStockQuantity(), 1);
        stockSpinner.setEditable(true);
